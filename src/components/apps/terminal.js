        ...
        switch (main) {
            ...
            case "code":
                if(words[0]==="." || words.length === 0){
                    ...
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-herbert, todoist, trash, settings, sendmsg]"; 
                }
                break;
            case "echo":
            ...
            case "about-herbert":
                if(words[0]==="." || words.length === 0){
                    this.props.openApp("about-herbert");
                }else{
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-herbert, todoist, trash, settings, sendmsg ]"; 
                }
                break;
