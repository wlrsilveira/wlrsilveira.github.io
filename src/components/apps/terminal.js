...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            PDPU: ["Sem-6"],
            books: ["Wagner-Resume.pdf", "Elon Musk: How the Billionaire CEO of SpaceX.pdf", "The $100 Startup_CHRIS_GUILLEBEAU.pdf", "The_Magic_of_Thinking_Big.pdf"],
        ...
        switch (main) {
            ...
            case "code":
                if(words[0]==="." || words.length === 0){
                    ...
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-wagner, todoist, trash, settings, sendmsg]"; 
                }
                break;
            case "echo":
            ...
            case "about-wagner":
                if(words[0]==="." || words.length === 0){
                    this.props.openApp("about-wagner");
                }else{
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-wagner, todoist, trash, settings, sendmsg ]"; 
                }
                break;
